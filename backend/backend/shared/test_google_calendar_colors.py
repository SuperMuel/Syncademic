...
def test_to_color_code() -> None:
    ...
    assert GoogleEventColor.TANGERINE.to_color_code() == "#ffb878"
    assert GoogleEventColor.BANANA.to_color_code() == "#fbd75b"
    assert GoogleEventColor.FLAMINGO.to_color_code() == "#ff887c"
...
def test_to_color_id() -> None:
    ...
    assert GoogleEventColor.TANGERINE.to_color_id() == "6"
    assert GoogleEventColor.BANANA.to_color_id() == "5"
    assert GoogleEventColor.FLAMINGO.to_color_id() == "4"
